...
void introScreen()
{
	...
	glColor3f(0, 0, 1);
	renderBitmapString(-150, 265, GLUT_BITMAP_TIMES_ROMAN_24, "Chittagong University Of Engineering & Technology");
	glColor3f(0.7, 0, 1);
	renderBitmapString(-80, 230, GLUT_BITMAP_TIMES_ROMAN_24, "DEPARTMENT OF CSE");
	glColor3f(1, 0.5, 0);
	renderBitmapString(-70, 120, GLUT_BITMAP_TIMES_ROMAN_24, "A MINI PROJECT ON");
	glColor3f(1, 0, 0);
	renderBitmapString(-95, 90, GLUT_BITMAP_TIMES_ROMAN_24, "FLAPPY BIRD ~ THE GAME");
	glColor3f(1, 0.5, 0);
	renderBitmapString(-290, -30, GLUT_BITMAP_TIMES_ROMAN_24, "Designed By:");
	glColor3f(0.5, 0, 0.5);
	renderBitmapString(-260, -60, GLUT_BITMAP_TIMES_ROMAN_24, "Ahasan Kabir       (1704055)");
	renderBitmapString(-260, -90, GLUT_BITMAP_TIMES_ROMAN_24, "Nahid Hossain      (1704061)");
	glColor3f(1, 0.5, 0);
	renderBitmapString(40, -30, GLUT_BITMAP_TIMES_ROMAN_24, "Supervised By:");
	glColor3f(0.5, 0.2, 0.2);
	renderBitmapString(70, -60, GLUT_BITMAP_TIMES_ROMAN_24, "Dr. Muhammad Ibrahim Khan");
	renderBitmapString(70, -90, GLUT_BITMAP_TIMES_ROMAN_24, "Md. Mynul Hasan");
	glColor3f(1, 0.1, 1);
